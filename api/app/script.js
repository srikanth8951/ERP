...
-------------------------------------------*/
   ...
   -------------------------------------------*/
    ...
    if ($("#newevent-form-main").length) {
        $("#newevent-form-main").validate({
            rules: {
                name: {
                    required: true,
                    minlength: 2
    ...
    if ($("#newevent-form-2").length) {
        $("#newevent-form-2").validate({
            rules: {
                img_logo: {
                    required: true,
                    minlength: 2
            ...
            messages: {
                name: "Please upload valid image"
            },
    ...
    if ($("#newevent-form-3").length) {
        $("#newevent-form-3").validate({
            rules: {
                img_logo: {
                    required: true,
                    minlength: 2
...
$("#rsvp-form-1").submit(function(e) {
    
    var err = 0;
    if($('#attenda').is(':checked') || $('#attendb').is(':checked')) {
        $('.attende_box').css('border','1px dashed #969883');

      }else{
        $('.attende_box').css('border','2px solid red');
        err++;
        //e.preventDefault();

      }

      var totalcoguests = $('#totalcoguests').val();
      for (let i = 0; i < totalcoguests; i++) {
        //alert(i);
         if($('#attenda_'+i).is(':checked') || $('#attendb_'+i).is(':checked')  ) {
             $('.attende_box_'+i).css('border','1px dashed #969883');
         }else{
        $('.attende_box_'+i).css('border','2px solid red');
        err++;
        //e.preventDefault();
