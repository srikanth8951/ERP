...
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
  ...
  $routes->get('contract_job/log/list', 'Admin\ContractJob::logs');
  ...
  $routes->get('contract_job/ppm/list', 'Admin\ContractJob::getContractJobPPMFrquencies');

  //Profile update
  $routes->get('profile/detail', 'Admin\Profile::getUser');
  $routes->post('profile/edit', 'Admin\Profile::editUser');
  ...
  $routes->get('standard_operating_procedure/list', 'Admin\StandardOperatingProcedure::index');
  $routes->get('standard_operating_procedure/detail', 'Admin\StandardOperatingProcedure::getProcedure');
  $routes->post('standard_operating_procedure/add', 'Admin\StandardOperatingProcedure::addProcedure');
  $routes->post('standard_operating_procedure/edit', 'Admin\StandardOperatingProcedure::editProcedure');
  $routes->post('standard_operating_procedure/delete', 'Admin\StandardOperatingProcedure::deleteProcedure');
  $routes->get('standard_operating_procedure/autocomplete', 'Admin\StandardOperatingProcedure::autocomplete');
  ...
  $routes->get('store/sub_category/autocomplete', 'Admin\Store\Category::autocompleteSubCategory');
  ...
  // Store Product
  $routes->get('store/product/list', 'Admin\Store\Product::index');
  $routes->get('store/product/detail', 'Admin\Store\Product::getProduct');
  $routes->post('store/product/add', 'Admin\Store\Product::addProduct');
  $routes->post('store/product/edit', 'Admin\Store\Product::editProduct');
  $routes->post('store/product/delete', 'Admin\Store\Product::deleteProduct');
  $routes->get('store/product/autocomplete', 'Admin\Store\Product::autocomplete');
  $routes->post('store/product/add/stock', 'Admin\Store\Product::addProductStock');

  // Store request
  $routes->get('store/product/request/list', 'Admin\Store\ProductRequest::index');
  $routes->get('store/product/request/detail', 'Admin\Store\ProductRequest::getProductRequest');

  $routes->get('store/user/list', 'Admin\Store\Users::index');
  $routes->get('store/user/detail', 'Admin\Store\Users::getEmployee');
  $routes->post('store/user/add', 'Admin\Store\Users::addEmployee');
  $routes->post('store/user/edit', 'Admin\Store\Users::editEmployee');
  $routes->post('store/user/delete', 'Admin\Store\Users::deleteEmployee');
  $routes->post('store/user/status/update', 'Admin\Store\Users::setEmployeeStatus');
  $routes->get('store/user/autocomplete', 'Admin\Store\Users::autocomplete');
...
$routes->group('employee', ['filter' => 'auth'], function ($routes) {
  ...
  // localisation
  $routes->get('localisation/country/list', 'Employee\Localisation::autocompleteCountry');
  $routes->get('localisation/state/list', 'Employee\Localisation::autocompleteState');
  $routes->get('localisation/city/list', 'Employee\Localisation::autocompleteCity');
  $routes->get('localisation/currency/autocomplete', 'Employee\Localisation::autocompleteCurrency');

  // Customer Sector
  $routes->get('customer_sector/list', 'Employee\CustomerSector::index');
  $routes->get('customer_sector/detail', 'Employee\CustomerSector::getCustomerSector');
  $routes->post('customer_sector/add', 'Employee\CustomerSector::addCustomerSector');
  $routes->post('customer_sector/edit', 'Employee\CustomerSector::editCustomerSector');
  $routes->post('customer_sector/delete', 'Employee\CustomerSector::deleteCustomerSector');
  $routes->get('customer_sector/autocomplete', 'Employee\CustomerSector::autocomplete');
  $routes->get('customer_sector_type/autocomplete', 'Employee\CustomerSector::typeAutocomplete');

  // Payment Terms
  $routes->get('payment_term/list', 'Employee\PaymentTerm::index');
  $routes->get('payment_term/detail', 'Employee\PaymentTerm::getPaymentTerm');
  $routes->post('payment_term/add', 'Employee\PaymentTerm::addPaymentTerm');
  $routes->post('payment_term/edit', 'Employee\PaymentTerm::editPaymentTerm');
  $routes->post('payment_term/delete', 'Employee\PaymentTerm::deletePaymentTerm');
  $routes->get('payment_term/autocomplete', 'Employee\PaymentTerm::autocomplete');

  // Customer user
  $routes->get('customer/list', 'Employee\Customer::index');
  $routes->get('customer/detail', 'Employee\Customer::getCustomer');
  $routes->post('customer/autocomplete', 'Employee\Customer::autocomplete');
...
$routes->group('employee/dmt', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\dmt'], function ($routes) {
  ...
  $routes->get('contract_job/log/list', 'ContractJob::logs');
  $routes->get('contract_job/ppm/list', 'ContractJob::getContractJobPPMFrquencies');

  $routes->post('contract_job/add', 'ContractJob::addContractJob');
  $routes->post('contract_job/renew', 'ContractJob::renewContractJob');
  $routes->post('contract_job/update', 'ContractJob::updateContractJob');
  ...
  $routes->get('customer/detail', 'Customer::getCustomer');
});
...
$routes->group('employee/aisd', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\aisd'], function ($routes) {
  ...
  // Asset
  $routes->get('asset/list', 'Asset::index');
  $routes->get('asset/detail', 'Asset::getAsset');

  // Region head
  $routes->get('users/region_head/list', 'Users\RegionHead::index');
  $routes->get('users/region_head/detail', 'Users\RegionHead::getEmployee');

  //RegionalServiceDeliveryHead
  $routes->get('users/rsd_head/list', 'Users\RegionalServiceDeliveryHead::index');
  $routes->get('users/rsd_head/detail', 'Users\RegionalServiceDeliveryHead::getEmployee');

  //AreaServiceDeliveryHead
  $routes->get('users/asd_head/list', 'Users\AreaServiceDeliveryHead::index');
  $routes->get('users/asd_head/detail', 'Users\AreaServiceDeliveryHead::getEmployee');

  // Area head
  $routes->get('users/area_head/list', 'Users\AreaHead::index');
  $routes->get('users/area_head/detail', 'Users\AreaHead::getEmployee');

  // engineer
  $routes->get('users/engineer/list', 'Users\Engineer::index');
  $routes->get('users/engineer/detail', 'Users\Engineer::getEmployee');

  // Client Account Manager
  $routes->get('users/client_account_manager/list', 'Users\ClientAccountManager::index');
  $routes->get('users/client_account_manager/detail', 'Users\ClientAccountManager::getEmployee');
});
...
$routes->group('employee/regionalHead', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\regionalHead'], function ($routes) {
  ...
  $routes->get('store_product/request/list', 'StoreProductRequest::index');
  $routes->get('store_product/request/detail', 'StoreProductRequest::getProductRequest');
  $routes->post('store_product/request/approval', 'StoreProductRequest::productRequestAprroval');
  $routes->post('store_product/request/reject', 'StoreProductRequest::productRequestReject');
...
$routes->group('employee/nationalHead', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\nationalHead'], function ($routes) {
  ...
  //AllIndiaServiceDeliveryHead
  $routes->get('users/aisd_head/detail', 'Users\AllIndiaServiceDeliveryHead::getEmployee');
...
$routes->group('employee/manager', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\manager'], function ($routes) {
  // cam User
  $routes->get('profile/detail', 'Profile::getEmployee');
  $routes->post('profile/edit', 'Profile::editEmployee');
...
$routes->group('employee/supervisor', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\supervisor'], function ($routes) {
  // cam User
  $routes->get('profile/detail', 'Profile::getEmployee');
  $routes->post('profile/edit', 'Profile::editEmployee');
...
$routes->group('employee/technician', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\technician'], function ($routes) {
  // cam User
  $routes->get('profile/detail', 'Profile::getEmployee');
  $routes->post('profile/edit', 'Profile::editEmployee');
...
$routes->group('employee/store', ['filter' => 'auth', 'namespace' => 'App\Controllers\Employee\store'], function ($routes) {
  // DMT User
  $routes->get('profile/detail', 'Profile::getEmployee');
  $routes->post('profile/edit', 'Profile::editEmployee');

  // Store Category
  $routes->get('category/list', 'Category::index');
  $routes->get('category/sub_category/list', 'Category::getSubCategoryDetails');
  $routes->get('category/detail', 'Category::getCategory');
  ...
  $routes->get('category/autocomplete', 'Category::autocomplete');
  $routes->get('sub_category/autocomplete', 'Category::autocompleteSubCategory');


  // Store Product
  $routes->get('product/list', 'Product::index');
  $routes->get('product/detail', 'Product::getProduct');
  ...
  $routes->get('product/autocomplete', 'Product::autocomplete');
  $routes->post('product/add/stock', 'Product::addProductStock');

  // Store request
  $routes->get('product/request/list', 'ProductRequest::index');
  $routes->get('product/request/detail', 'ProductRequest::getProductRequest');
  $routes->post('product/request/approval', 'ProductRequest::productRequestAprroval');
});


// login url for cuastmer
$routes->post('customer/login', 'Customer\Account::login');

// customer url group
$routes->group('customer', ['filter' => 'auth', 'namespace' => 'App\Controllers\Customer'], function ($routes) {

  

  $routes->post('checkLoggedin', 'Account::checkLoggedin');
  ...
  $routes->get('contract_type/autocomplete', 'ContractType::autocomplete');
  $routes->get('contract_status/autocomplete', 'ContractStatus::autocomplete');

  $routes->get('customer_sector/autocomplete', 'CustomerSector::autocomplete');
  $routes->get('customer_sector_type/autocomplete', 'CustomerSector::typeAutocomplete');
  ...
  //Profile update
  $routes->get('profile/detail', 'Profile::getCustomer');
  $routes->post('profile/edit', 'Profile::editCustomer');
  
});

// Cron
$routes->group('cron', ['namespace' => 'App\Controllers\Cron'], function ($routes) {
  $routes->cli('contract_job/add_checklists_tracks', 'ContractJob::addChecklistsTracks');
  $routes->cli('contract_job/check_expiry', 'ContractJob::checkExpiry');
});
