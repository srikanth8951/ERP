...
$(function () {
    ...
    const listArea = $('#empnationalhead--deatils--area');
    const newContainer = listArea.find('#empNationalHeadNewArea');
    const detailContainer = listArea.find('#empNationalHeadDetailArea');
    ...
    window.loadEmpDetailView = function (type = '', employee = {}) {
        if (type == 'new') {
            ...
            if (Object.keys(employee).length > 0) {
                detailContainer.find('[data-employee-detail="nationalHead"]').html(`<div class="card m-b-20">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-5">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col">
                                <a href="${formUrl('admin/national_head/edit/' + employee.employee_id)}" id="btn-edit-employee-nationalhead" class="btn btn-sm btn-outline-primary waves-effect waves-light"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                            </div>
    ...
    $(detailContainer).on('click', '#btn-delete-employee-nationalhead', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: formApiUrl('admin/employee/national_head/delete', { employee_id: employee_id }),
                    type: 'post',
                    dataType: 'json',
                    headers: {
                        Authorization: `Bearer ${wapLogin.getToken()}`
