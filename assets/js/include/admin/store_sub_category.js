 ...
 */
 ...
 $(function () {
     ...
     $('#btn-add-store-sub-category').click(function (e) {
         ...
         sub_categoryForm.attr('action', formApiUrl('admin/store/category/add'));
    ...
    window.loadAutocompleteparents = function (options = {}) {
        ...
        $.ajax({
        url: formApiUrl("admin/store/category/autocomplete", options),
        type: "get",
        dataType: "json",
        headers: {
                         ...
                         if (details.length && pagination.total > 0) {
                             ...
                             listPagination.find('.list-pagination').pagination({
                                 ...
                                 onPageClick: function (pageNumber, event) {
                                     var page_link = formApiUrl('admin/store/category/sub_category/list', { start: ((parseInt(pagination.length) * (pageNumber - 1)) + 1)});
     ...
     lengthContainer.change(function () {
         loadDetails(formApiUrl('admin/store/category/sub_category/list'));  // Load store-sub-category details
     });
     ...
     function savesub_category() {
         ...
         $.ajax({
             ...
             if (res.status == 'success') {
                 loadDetails(formApiUrl('admin/store/category/sub_category/list'));  // Load sub_category details
         ...
         $.ajax({
             ...
             if (res.status == 'success') {
                 if (res.store_category) {
                     ...
                     sub_categoryForm.attr('action', formApiUrl('admin/store/category/edit', { store_category_id: store_category.category_id }));
         ...
         Swal.fire({
             ...
             if (result.isConfirmed) {
                 ...
                 $.ajax({
                     ...
                     if (res.status == 'success') {
                         loadDetails(formApiUrl('admin/store/category/sub_category/list'));  // Load store_category details
                         toastr.success(res.message);
