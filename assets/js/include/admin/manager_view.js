 ...
 */
 ...
 $(function () {
     ...
     const newContainer = listArea.find('#empManagerNewArea');
     const detailContainer = listArea.find('#empManagerDetailArea');
     ...
     window.loadEmpDetailView = function (type = '', employee = {}) {
         if (type == 'new') {
             ...
             if (Object.keys(employee).length > 0) {
                 detailContainer.find('[data-employee-detail="manager"]').html(`<div class="card m-b-20">
                     <div class="card-body">
                         <div class="row">
                             <div class="col-5">
             ...
             listArea.append(`<div id="emptyManagerDetailArea">
