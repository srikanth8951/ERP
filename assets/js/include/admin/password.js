...
$(function () {
  const employeeAdminForm = $("#employeeAdminForm");
  var employeeAdminFormValidator;

  // employee Form
  employeeAdminFormValidator = employeeAdminForm.validate({
  ...
  function saveEmployee() {
    let loadSwal;
    var formData = new FormData(employeeAdminForm[0]);
    ...
    $.ajax({
      ...
      .done(function (res) {
        if (res.status == "success") {
          ...
          employeeAdminForm[0].reset(); // Reset form
          setTimeout(function () {
  ...
  employeeAdminForm.submit(function (e) {
    e.preventDefault();
     
    if (employeeAdminFormValidator.valid()) {
      saveEmployee();
    }
  });
});
