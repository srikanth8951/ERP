 ...
 */
 ...
 $(function () {
     ...
     const newContainer = listArea.find('#empTechnicianNewArea');
     const detailContainer = listArea.find('#empTechnicianDetailArea');
     ...
     window.loadEmpDetailView = function (type = '', employee = {}) {
         if (type == 'new') {
             ...
             if (Object.keys(employee).length > 0) {
                 detailContainer.find('[data-employee-detail="technician"]').html(`<div class="card m-b-20">
                     <div class="card-body">
                         <div class="row">
                             <div class="col-5">
             ...
             listArea.append(`<div id="emptyTechnicianDetailArea">
