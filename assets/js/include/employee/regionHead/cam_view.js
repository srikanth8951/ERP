...
$(function () {
  ...
  const newContainer = listArea.find("#empCAMNewArea");
  const detailContainer = listArea.find("#empCAMDetailArea");
  ...
  window.loadEmpDetailView = function (type = "", employee = {}) {
    if (type == "new") {
      ...
      if (Object.keys(employee).length > 0) {
        detailContainer.find('[data-employee-detail="cam"]')
      ...
      listArea.append(`<div id="emptyCAMDetailArea">
