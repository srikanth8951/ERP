...
$(function () {
  ...
  const newContainer = listArea.find("#empASDHeadNewArea");
  const detailContainer = listArea.find("#empASDHeadDetailArea");
  ...
  window.loadEmpDetailView = function (type = "", employee = {}) {
    if (type == "new") {
      ...
      if (Object.keys(employee).length > 0) {
        detailContainer.find('[data-employee-detail="asdHead"]')
      ...
      listArea.append(`<div id="emptyASDHeadDetailArea">
