 ...
 */
 ...
 $(function () {
                     ...
                     if (res.customers) {
                         ...
                         if (details.length && pagination.total > 0) {
                             ...
                             $.each(details, function (listIn, listVal) {
                                 ...
                                 var customerViewLink = formUrl('employee/cam/customer/view/' + listVal.customer_id);
                                 listContainer.append(`<div class="col-md-12">
                                     <div class="card m-b-20 card-body" style="padding: 0.75rem;">
                                         <div class="row align-items-center ">
                            ...
                            $('.clickable').click(function() { 
                             ...
                             listPagination.find(".list-pagination").pagination({
                                 ...
                                 onPageClick: function (pageNumber, event) {
                                     var page_link = formApiUrl('employee/cam/customer/list', { start: ((parseInt(pagination.length) * (pageNumber - 1)) + 1)});
     ...
     searchForm.submit(function (e) {
         e.preventDefault();
         loadCustomerDetails(formApiUrl('employee/cam/customer/list'));  // Load customer details
     });
