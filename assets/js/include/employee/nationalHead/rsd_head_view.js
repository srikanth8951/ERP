...
$(function () {
  ...
  const newContainer = listArea.find("#empRSDHeadNewArea");
  const detailContainer = listArea.find("#empRSDHeadDetailArea");
  ...
  window.loadEmpDetailView = function (type = "", employee = {}) {
    if (type == "new") {
      ...
      if (Object.keys(employee).length > 0) {
        detailContainer.find('[data-employee-detail="rsdHead"]')
      ...
      listArea.append(`<div id="emptyRSDHeadDetailArea">
