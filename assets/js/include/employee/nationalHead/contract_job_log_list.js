 ...
 */
 ...
 $(function () {
                     ...
                     if (res.contract_jobs) {
                         ...
                         if (details.length && pagination.total > 0) {
                             ...
                             $.each(details, function (listIn, listVal) {
                                 ...
                                 var contractJobViewLink = formUrl('employee/nationalHead/contract_job_log/view/' + listVal.contract_job_id + '/' + contract_job_id);
                             ...
                             listPagination.find(".list-pagination").pagination({
                                 ...
                                 onPageClick: function (pageNumber, event) {
                                     var page_link = formApiUrl('employee/nationalHead/contract_job_log/log/list', { start: ((parseInt(pagination.length) * (pageNumber - 1)) + 1)});
     ...
     searchForm.submit(function (e) {
         e.preventDefault();
         loadContractJobDetails(formApiUrl('employee/nationalHead/contract_job/log/list', { contract_job_id: contract_job_id }));  // Load contract job details
     });
