...
$(function () {
  ...
  const newContainer = listArea.find("#empAreaHeadNewArea");
  const detailContainer = listArea.find("#empAreaHeadDetailArea");
  ...
  window.loadEmpDetailView = function (type = "", employee = {}) {
    if (type == "new") {
      ...
      if (Object.keys(employee).length > 0) {
        detailContainer.find('[data-employee-detail="areaHead"]')
      ...
      listArea.append(`<div id="emptyAreaHeadDetailArea">
