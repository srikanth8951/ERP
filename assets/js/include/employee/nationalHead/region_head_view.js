...
$(function () {
  ...
  const newContainer = listArea.find("#empRegionHeadNewArea");
  const detailContainer = listArea.find("#empRegionHeadDetailArea");
  ...
  window.loadEmpDetailView = function (type = "", employee = {}) {
    if (type == "new") {
      ...
      if (Object.keys(employee).length > 0) {
        detailContainer.find('[data-employee-detail="regionHead"]')
      ...
      listArea.append(`<div id="emptyRegionHeadDetailArea">
