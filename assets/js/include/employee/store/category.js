 ...
 */
 ...
 $(function () {
     ...
     $('#btn-add-store_category').click(function (e) {
         ...
         store_categoryForm.attr('action', formApiUrl('employee/store/category/add'));
                         ...
                         if (details.length && pagination.total > 0) {
                             ...
                             listPagination.find('.list-pagination').pagination({
                                 ...
                                 onPageClick: function (pageNumber, event) {
                                     var page_link = formApiUrl('employee/store/category/list', { start: ((parseInt(pagination.length) * (pageNumber - 1)) + 1)});
     ...
     lengthContainer.change(function () {
         loadDetails(formApiUrl('employee/store/category/list'));  // Load store_category details
     });
         ...
         $.ajax({
             ...
             if (res.status == 'success') {
                 if (res.store_category) {
                     ...
                     store_categoryForm.attr('action', formApiUrl('employee/store/category/edit', { store_category_id: store_category.category_id }));
