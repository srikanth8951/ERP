...
$(function () {
                    ...
                    if (res.assets) {
                        ...
                        if (details.length && pagination.total > 0) {
                            ...
                            $.each(details, function (listIn, listVal) {
                                let assetViewLink = formUrl(`employee/dmt/asset/view/${listVal.asset_id}`);
                                if (listVal.status == 1) {
                            ...
                            listPagination.find(".list-pagination").pagination({
                                ...
                                onPageClick: function (pageNumber, event) {
                                    var page_link = formApiUrl('employee/dmt/asset/list', { start: ((parseInt(pagination.length) * (pageNumber - 1)) + 1)});
    ...
    searchForm.submit(function (e) {
        e.preventDefault();
        loadAssetDetails(formApiUrl('employee/dmt/asset/list'));  // Load contract job details
    });
