        ...
        <div class="row">
            <div class="col-md-6 col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    ...
                    <p class=" mb-0 m-t-20 text-muted">Total completed: 22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    ...
                    <div class="mini-stat-info">
                        <span class="counter text-blue-grey">5241</span>
                        New Contracts
                    </div>
                    <div class="clearfix"></div>
                    <p class="text-muted mb-0 m-t-20">Total accepted: 2506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    ...
                    <div class="mini-stat-info">
                        <span class="counter text-brown">5412</span>
                        O & M 
                    </div>
                    <div class="clearfix"></div>
                    <p class="text-muted mb-0 m-t-20">Total requests: 22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>
                </div>
            </div>
            <div class="col-md-6 col-xl-3">
                <div class="mini-stat clearfix bg-white">
                    ...
                    <div class="mini-stat-info">
                        <span class="counter text-teal">2544</span>
                        Complaints
                    </div>
                    <div class="clearfix"></div>
                    <p class="text-muted mb-0 m-t-20">Total requests: 22506 <span class="pull-right"><i class="fa fa-caret-up m-r-5"></i>10.25%</span></p>
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-9 pr-md-0">
                        <div class="card m-b-20" style="height: 486px;">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Monthly Jobs/Contracts</h4>
            ...
            <div class="col-xl-3">
                <div class="card m-b-20">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Complaints Analytics</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-vertical mb-0">
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/users/avatar-2.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                        Herbert C. Patton
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/users/avatar-3.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                        Mathias N. Klausen
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/users/avatar-4.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                        Nikolaj S. Henriksen
                                    </td>
                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/users/avatar-5.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                        Lasse C. Overgaard
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/users/avatar-6.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                        Kasper S. Jessen
                                    </td>
                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vertical mb-0">
                                ...
                                <tr>
                                    <td>#12354781</td>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/products/1.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                ...
                                <tr>
                                    <td>#52140300</td>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/products/2.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                ...
                                <tr>
                                    <td>#96254137</td>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/products/3.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                ...
                                <tr>
                                    <td>#12365474</td>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/products/4.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                ...
                                <tr>
                                    <td>#85214796</td>
                                    <td>
                                        <img src="<?= base_url()?>assets/images/products/5.jpg" alt="user-image" style="height: 46px;" class="rounded mr-2" />
                                        BeoPlay Speaker
                                    </td>
                                    <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                    <td>
    ...
    $(function() {
        ...
        $.when(wapLogin.check()).done(function(res) {
            if (res.status == 'success') {
                ...
                wapLogin.showDialog('No response status');
            }
