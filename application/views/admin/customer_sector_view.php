<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="customer_sector--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        <!-- <a data-toggle="modal" href="#customer_sectorUploadModal" data-backdrop="static" data-keyboard="false" class="btn  btn-outline-dark waves-effect waves-light ">Upload</a> -->
                        <button id="btn-add-customer_sector" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="customer_sectorListArea">
                            ...
                            <table class="table table-bordered dt-responsive nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Customer Sub-sector</th>
                                        <th width="15%">Action</th>
                                    </tr>
                                </thead>
                                <tbody data-container="customer_sectorTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="customer_sectorTlistArea" class="clearfix mb-4">
...
<!-- customer_sector Modal -->
<div class="modal fade" id="customer_sectorModal">
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">Customer Sector</h4>
                <button type="button" data-dismiss="modal" class="close"><i class="mdi mdi-close"></i></button>
            </div>
            <div class="modal-body">
                <form id="customer_sectorForm" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label">Customer Sector<span class="text-danger"> *</span></label>
                                <input type="text" name="title" class="form-control" />
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group ele-jqValid">
                                <label class="control-label">Customer Sub-sector<span class="text-danger"> *</span></label>
                                <select name="type_id" data-toggle="select2" class="select2" required></select>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <a href="javascript:void(0)" id="btn-reset-customer_sector-form" class="btn btn-secondary btn-sm" style="display:none;">
...
<!-- Upload Modal -->
<div class="modal fade" id="customer_sectorUploadModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <a class="btn btn-link btn-sm" href="<?php echo base_url('assets/uploads/customer_sector.xlsx');?>"><i class="fa fa-file-excel-o"></i>&nbsp;Download sample</a>
                <button form="uploadForm" class="btn btn-primary" id="btn-upload-customer_sector">Submit</button>
            </div>
        </div>
    </div>
</div>

<div id="customer_sectorListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title">customer_sectores List</h4>
            </div>
            ...
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">   
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">                                                                 
                   <div class="table-responsive-sm mt-6">
                        <table id="customer_sectorTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>    
                </div> 
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="customer_sector-submit">Submit</button>   
                </div>                                                   
            </form>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/js/include/admin/customer_sector.js'); ?>"></script>
<script src="<?php echo base_url('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js'); ?>"></script>
<!-- <script src="<?php echo base_url('assets/js/include/admin/upload_customer_sector.js'); ?>"></script> -->
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('admin/customer_sector/list'));
        }
