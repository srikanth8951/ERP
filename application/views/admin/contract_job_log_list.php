        ...
        <div class="p-2" style="background-color: #dee1e5;"> 
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url('admin/contract_job/view/' . $contract_job_id) ?>" class="btn btn-outline-secondary waves-effect waves-light"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
        <br>
...
<script src="<?php echo base_url('assets/js/include/admin/contract_job_log_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('admin/contract_job/log/list', { contract_job_id: contract_job_id }));
        }
