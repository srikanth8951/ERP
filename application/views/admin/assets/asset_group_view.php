<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="group--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        <!-- <a data-toggle="modal" href="#groupUploadModal" data-backdrop="static" data-keyboard="false" class="btn  btn-outline-dark waves-effect waves-light ">Upload</a> -->
                        <button id="btn-add-group" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="groupListArea">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered dt-responsive nowrap">
                                ...
                                <tbody data-container="groupTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="groupTlistArea" class="clearfix mb-4">
    ...
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">Group</h4>
            ...
            <div class="modal-body">
                <form id="groupForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <a href="javascript:void(0)" id="btn-reset-group-form" class="btn btn-secondary btn-sm" style="display:none;">
...
<!-- Upload Modal -->
<div class="modal fade" id="groupUploadModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button form="uploadForm" class="btn btn-primary" id="btn-upload-group">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div id="groupListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">
                    <div class="table-responsive-sm mt-6">
                        <table id="groupTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="group-submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/js/include/admin/group.js'); ?>"></script>
<!-- <script src="<?php echo base_url('assets/js/include/admin/upload_group.js'); ?>"></script> -->
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('admin/asset/group/list'));
        }
