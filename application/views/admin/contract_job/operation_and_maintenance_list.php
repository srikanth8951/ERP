        ...
        <div class="p-2" style="background-color: #dee1e5;"> 
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url('admin/contract_job/operation_and_maintenance/add') ?>" class="btn  btn-outline-primary waves-effect waves-light ">Add</a>
                </div>
            </div>
        </div>
        <br>
...
<script src="<?php echo base_url('assets/js/include/admin/contract_job/operation_and_maintenance_list.js'); ?>"></script>
