<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="work_expertise--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        <a data-toggle="modal" href="#workExpertiseUploadModal" data-backdrop="static" data-keyboard="false" class="btn  btn-outline-dark waves-effect waves-light ">Upload</a>
                        <button id="btn-add-work_expertise" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="work_expertiseListArea">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered dt-responsive nowrap">
                                <thead>
                                    <tr>
                                        <th width="15%">Sl.No</th>
                                        <th>Work expertise name</th>
                                        <th width="15%">Action</th>
                                    </tr>
                                </thead>
                                <tbody data-container="work_expertiseTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="work_expertiseTlistArea" class="clearfix mb-4">
...
<!-- work_expertise Modal -->
<div class="modal fade" id="work_expertiseModal">
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">Work Expertise</h4>
                <button type="button" data-dismiss="modal" class="close"><i class="mdi mdi-close"></i></button>
            </div>
            <div class="modal-body">
                <form id="work_expertiseForm" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="form-group">
                        <a href="javascript:void(0)" id="btn-reset-work_expertise-form" class="btn btn-secondary btn-sm" style="display:none;">
...
<!-- Upload Modal -->
<div class="modal fade" id="workExpertiseUploadModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <a class="btn btn-link btn-sm" href="<?php echo base_url('assets/uploads/work-expertise.csv'); ?>"><i class="fa fa-file-excel-o"></i>&nbsp;Download sample</a>
                <button form="uploadForm" class="btn btn-primary" id="btn-upload-workExpertise">Submit</button>
            </div>
        </div>
    </div>
</div>
...
<div id="workExpertiseListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title">Work Expertises List</h4>
            </div>
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">
                    <span id="emsg" style="display: none;text-align: center;color:#f02121;margin: 10px;">Already Existing workExpertises are Higlighted</span>
                    <span id="duplicate-msg" style="text-align: center;color:#f02121;margin: 10px;"></span>
                    <div class="table-responsive-sm mt-6">
                        <table id="workExpertiseTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="workExpertise-submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/js/include/admin/work_expertise.js'); ?>"></script>
<script src="<?php echo base_url('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/admin/upload_work_expertise.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('admin/work_expertise/list'));
        }
