            ...
            <form class="" action="#" id="contract-job-form">
                ...
                <div class="form-group">
                    <div>
                        ...
                        <a href="<?php echo base_url(); ?>admin/contract_job" class="btn btn-secondary waves-effect">
                            Cancel
                        </a>
                    </div>
                </div>
...
<script src="<?php echo base_url('assets/js/include/admin/contract_job_asset_upload.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/admin/contract_job_form.js'); ?>"></script>
