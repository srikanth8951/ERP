...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empsotre--deatils--area">
    <div class="card card-body p-2 mb-2">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeStoreForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/store/users/" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/store_user_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/store/user/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/store/user/add');
                // Load autocompletes
