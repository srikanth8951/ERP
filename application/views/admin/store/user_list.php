    ...
    <div class="card card-body p-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url('admin/store/users/add') ?>" class="btn btn-outline-primary mt-1"><i class="mdi mdi-account-plus"></i> Add</a>
        ...
        <br>
        <div class="row" data-container="empStoreArea"></div>

        <div class="row align-items-center justify-content-between" data-pagination="empStoreArea">
            <div class="col">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/store_user_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('admin/store/user/list'));
        }
