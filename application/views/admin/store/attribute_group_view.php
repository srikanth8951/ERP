<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="attribute_group--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        <button id="btn-add-attribute_group" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="attribute_groupListArea">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered dt-responsive nowrap">
                                ...
                                <tbody data-container="attribute_groupTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="attribute_groupTlistArea" class="clearfix mb-4">
...
<!-- attribute_group Modal -->
<div class="modal fade" id="attribute_groupModal">
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">Attribute Group</h4>
                <button type="button" data-dismiss="modal" class="close"><i class="mdi mdi-close"></i></button>
            </div>
            <div class="modal-body">
                <form id="attribute_groupForm" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label class="control-label">Name<span class="text-danger"> *</span></label>
                                <input type="text" name="attribute_group_name" class="form-control" />
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="form-group">
                        <a href="javascript:void(0)" id="btn-reset-attribute_group-form" class="btn btn-secondary btn-sm" style="display:none;">
...
<script src="<?php echo base_url('assets/js/include/admin/attribute_group.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('admin/store/attribute_group/list'));
        }
