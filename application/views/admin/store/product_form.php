                ...
                <form id="productForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/store/products/" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script src="<?= base_url('assets/js/include/admin/store_product_form.js') ?>"></script>
    ...
    $(function() {
        ...
        async function loadInitFunctions() {
            if (form_view_type == 'edit') {
                formActionUrl = formApiUrl('admin/store/product/edit', {
                    product_id: product_id
                });
                loadProductDetail();
            } else {
                formActionUrl = formApiUrl('admin/store/product/add');
