<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="area--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        <a data-toggle="modal" href="#areaUploadModal" data-backdrop="static" data-keyboard="false" class="btn  btn-outline-dark waves-effect waves-light ">Upload</a>
                        <button id="btn-add-area" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="areaListArea">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered dt-responsive nowrap">
                                ...
                                <tbody data-container="areaTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="areaTlistArea" class="clearfix mb-4">
    ...
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">City</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group ele-jqValid">
                                ...
                                <select name="branch_id" data-toggle="select2" class="select2"></select>
                            </div>
                        </div>
                        <div class="col-12">
...
<!-- Upload Modal -->
<div class="modal fade" id="areaUploadModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button form="uploadForm" class="btn btn-primary" id="btn-upload-area">Submit</button>
            </div>
        </div>
    </div>
</div>

<div id="areaListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">
                    ...
                    <div class="table-responsive-sm mt-6">
                        <table id="areaTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="area-submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo base_url('assets/js/include/admin/area.js'); ?>"></script>
<script src="<?php echo base_url('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/admin/upload_area.js'); ?>"></script>
<script>
    $(function() {
        $('[data-toggle="select2"]').select2();

        function loadInitFunctions() {
            loadDetails(formApiUrl('admin/area/list'));
        }
