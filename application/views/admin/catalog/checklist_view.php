<?php
    ...
    if ($group) {
        $actionBack = base_url('admin/catalog/checklist/' . $group);
    } else {
        $actionBack = base_url('admin/catalog/checklist');
    }
?>
<style>
                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            <div class="float-right" id="add-button-area">
                                <a href="<?php echo $actionBack; ?>" class="btn btn-secondary btn-sm waves-effect waves-light ml-2"><i class="mdi mdi-arrow-left-bold mr-2"></i>Back</a>
...
<?php $this->document->addScript(base_url('assets/js/include/admin/checklist_view_type1.js')); ?>
<?php $this->document->addScript(base_url('assets/js/include/admin/checklist_view_type2.js')); ?>
<?php $this->document->addScript(base_url('assets/js/page/admin/checklist_view.js')); ?>
