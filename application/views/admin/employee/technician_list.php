        ...
        <div class="p-2" style="background-color: #dee1e5;"> 
            <div class="row">
                ...
                <div class="col text-right">
                    ...
                    <a href="<?php echo base_url('admin/technician/add') ?>" class="btn  btn-outline-primary waves-effect waves-light ">Add</a>
                </div>
            </div>
        </div>
        <br>
        <div class="row" data-container="empTechnicianArea"></div>

        <div class="row align-items-center justify-content-between" data-pagination="empTechnicianArea">
            <div class="col">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/technician_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('admin/employee/technician/list'));
        }
