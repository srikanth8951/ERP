...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empnationalhead--deatils--area">
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeNationalHeadForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/national_head" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/national_head_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/national_head/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/national_head/add');
                // Load autocompletes
