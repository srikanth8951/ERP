...
<div class="page-content-wrapper">
    ...
    <div class="container-fluid" id="empdmt--deatils--area">
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url(); ?>admin/dmt" class="btn btn-outline-secondary mt-1"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
        <section id="empDMTDetailArea" style="display: none;">
            <div class="row">
                <div class="col-4" data-employee-detail="dmt">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col">
                                    <a href="javascript:void(0)" id="btn-edit-employee-dmt" class="btn btn-sm btn-outline-primary waves-effect waves-light"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                </div>
                                <div class="col text-right">
                                    <button id="btn-delete-employee-dmt" class="btn btn-sm btn-outline-danger waves-effect waves-light"><i class="fa fa-trash"></i>&nbsp;Remove</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/dmt_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('admin/employee/client_account_manager/detail', {
