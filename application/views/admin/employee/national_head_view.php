...
<div class="page-content-wrapper">
    ...
    <div class="container-fluid" id="empnationalhead--deatils--area">
        <style>
            .img_cls {
                width: 100px;
                border-radius: 6px;
        ...
        <section id="empNationalHeadNewArea" style="display: none;">
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body text-center">
                            <h4 class="mt-0 mb-4">National Head</h4>
                            <a href="<?php echo base_url('admin/national_head/add'); ?>" class="btn btn-sm btn-primary waves-effect waves-light"><i class="fa fa-plus"></i>&nbsp;Add</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="empNationalHeadDetailArea" style="display: none;">
            <div class="row">
                <div class="col-4" data-employee-detail="nationalHead">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col">
                                    <a href="javascript:void(0)" id="btn-edit-employee-nationalhead" class="btn btn-sm btn-outline-primary waves-effect waves-light"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                </div>
                                <div class="col text-right">
                                    <button id="btn-delete-employee-nationalhead" class="btn btn-sm btn-outline-danger waves-effect waves-light"><i class="fa fa-trash"></i>&nbsp;Remove</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/national_head_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('admin/employee/national_head/detail'));
        }
