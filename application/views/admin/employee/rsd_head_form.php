...
<div class="page-content-wrapper">
    ...
    <div class="card card-body p-2 mb-2">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeRSDHeadForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/rsd_head" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/rsd_head_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/rsd_head/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/rsd_head/add');
                // Load autocompletes
