...
<div class="page-content-wrapper">
    ...
    <div class="container-fluid" id="empaisdhead--deatils--area">
        <style>
            .img_cls {
                width: 100px;
                border-radius: 6px;
        ...
        <!-- <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url(); ?>admin/aisd_head" class="btn btn-outline-secondary mt-1"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div> -->
        <section id="empAISDHeadNewArea" style="display: none;">
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body text-center">
                            <h4 class="mt-0 mb-4">AISD Head</h4>
                            <a href="<?php echo base_url('admin/aisd_head/add'); ?>" class="btn btn-sm btn-primary waves-effect waves-light"><i class="fa fa-plus"></i>&nbsp;Add</a>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section id="empAISDHeadDetailArea" style="display: none;">
            <div class="row">
                <div class="col-4" data-employee-detail="aisdHead">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-5">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col">
                                    <a href="javascript:void(0)" id="btn-edit-employee-aisdhead" class="btn btn-sm btn-outline-primary waves-effect waves-light"><i class="fa fa-pencil"></i>&nbsp;Edit</a>
                                </div>
                                <div class="col text-right">
                                    <button id="btn-delete-employee-aisdhead" class="btn btn-sm btn-outline-danger waves-effect waves-light"><i class="fa fa-trash"></i>&nbsp;Remove</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" style="font-size: 16px;" data-toggle="tab" href="#home" role="tab">
                                <span class="d-none d-md-block">Contract Renewal Tracker</span><span class="d-block d-md-none"><i class="mdi mdi-home-variant h5"></i></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 16px;" data-toggle="tab" href="#profile" role="tab">
                                <span class="d-none d-md-block">PMS/O&M Checksy</span><span class="d-block d-md-none"><i class="mdi mdi-account h5"></i></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 16px;" data-toggle="tab" href="#messages" role="tab">
                                <span class="d-none d-md-block">Asset Data</span><span class="d-block d-md-none"><i class="mdi mdi-email h5"></i></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 16px;" data-toggle="tab" href="#settings" role="tab">
                                <span class="d-none d-md-block">SOP</span><span class="d-block d-md-none"><i class="mdi mdi-settings h5"></i></span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card m-b-20 card-body">
                                <h3 class="card-title font-20 mt-0">Job-47648
                ...
                <div class="tab-pane" id="messages" role="tabpanel">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card m-b-20 card-body">
                                <h3 class="card-title font-20 mt-0">Asset-47648
                                    <div class="float-right">
                                    </div>
                                </h3>
                                <div class="row">
                                    <div class="col-md-4">
                                        Asset Name : Electrical
                                    </div>
                                    <div class="col-md-4">
                                        Asset Group : O & M
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        Asset Location : South
                                    </div>
                                    <div class="col-md-4">
                                        Asset Sub-group : O & M supervisor
                                    </div>
                                    <div class="col-md-4">
                                        UOM : KG
                                    </div>
...
<script>
    const employee_id = "<?php echo $employee_id ?? 0; ?>";
</script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/aisd_head_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('admin/employee/aisd_head/detail'));
        }
