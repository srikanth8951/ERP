    ...
    <div class="card card-body p-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a data-toggle="modal" href="#regionHeadUploadModal" data-backdrop="static" data-keyboard="false" class="btn btn-outline-info mt-1"><i class=" mdi mdi-folder-upload"></i> Upload</a>
                    <a href="<?php echo base_url('admin/regional_head/add') ?>" class="btn btn-outline-primary mt-1"><i class="mdi mdi-account-plus"></i> Add</a>
        ...
        <br>
        <div class="row" data-container="empRegionHeadArea"></div>

        <div class="row align-items-center justify-content-between" data-pagination="empRegionHeadArea">
            <div class="col">
...
<!-- Upload Modal -->
<div class="modal fade" id="regionHeadUploadModal">
...
<div id="regionHeadListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">   
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">                                                                 
                   <div class="table-responsive-sm mt-6">
                        <table id="regionHeadTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>    
                </div> 
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/region_head_list.js'); ?>"></script>
<script src="<?php echo base_url('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/admin/upload_region_head.js'); ?>"></script>
<script>
    $(function() {
        $('[data-toggle="select2"]').select2();

        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('admin/employee/region_head/list'));
        }
