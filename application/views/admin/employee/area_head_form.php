...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empareahead--deatils--area">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeAreaHeadForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/area_head" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/area_head_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/area_head/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/area_head/add');
                // Load autocompletes
