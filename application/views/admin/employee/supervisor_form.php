...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empsupervisor--deatils--area">
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeSupervisorForm" action="#">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/supervisor_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        async function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/supervisor/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/supervisor/add');
                // Load autocompletes
                loadAutocompleteRegions();
                loadAutocompleteDepartments();
                loadAutocompleteDesignations();
                await loadAutocompleteAddressCountries({
                    element: $('#employeeSupervisorForm [name="country_id"]'),
                    params: {
                        selected: [101]
                    }
                });
                await loadAutocompleteAddressStates({
                    element: $('#employeeSupervisorForm [name="state_id"]'),
                    params: {
                        country_id: 101
                    }
                });
