...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/asd_head_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('admin/employee/asd_head/detail', {
