...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empaisdhead--deatils--area">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeAISDHeadForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>admin/aisd_head" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/aisd_head_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/aisd_head/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/aisd_head/add');
                // Load autocompletes
                // loadAutocompleteRegions();
                loadAutocompleteDepartments();
                loadAutocompleteDesignations();
                loadAutocompleteCountry({ selected: [101]});
