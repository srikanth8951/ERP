...
<div class="page-content-wrapper">
    <div class="container-fluid" id="emptechnician--deatils--area">
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeTechnicianForm" action="#">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/technician_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        async function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/technician/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/technician/add');
                // Load autocompletes
                loadAutocompleteRegions();
                loadAutocompleteDepartments();
                loadAutocompleteDesignations();
                await loadAutocompleteAddressCountries({
                    element: $('#employeeTechnicianForm [name="country_id"]'),
                    params: {
                        selected: [101]
                    }
                });
                await loadAutocompleteAddressStates({
                    element: $('#employeeTechnicianForm [name="state_id"]'),
                    params: {
                        country_id: 101
                    }
                });
