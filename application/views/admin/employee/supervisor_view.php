...
<div class="page-content-wrapper">
    ...
    <div class="container-fluid" id="empsupervisor--deatils--area">
        <style>
            .img_cls {
                width: 100px;
                border-radius: 6px;
        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url(); ?>admin/supervisor" class="btn btn-outline-secondary mt-1"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
        <section id="empSupervisorDetailArea" style="display: none;">
            <div class="row">
                <div class="col-4" data-employee-detail="supervisor">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/supervisor_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('admin/employee/supervisor/detail', {
