...
<div class="page-content-wrapper">
    <div class="container-fluid" id="empengineer--deatils--area">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form id="employeeEngineerForm" action="#">
                        ...
                        <div class="col-md-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row vendor_cls" style="display: none;">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="my-input">Vendor</label>
                                                <select name="vendor_id" id="input" data-toggle="select2" class="form-control select2" required="required"></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="form-group">
                <div>
                    ...
                    <a href="<?php echo base_url(); ?>admin/engineer" class="btn btn-secondary waves-effect">
                        Cancel
                    </a>
                </div>
            </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/engineer_form.js'); ?>"></script>
    ...
    $(function() {
        ...
        async function loadInitFunctions() {
            if (emp_form_type == 'edit') {
                formActionUrl = formApiUrl('admin/employee/engineer/edit', {
                    employee_id: employee_id
                });
                loadEmpDetail();
            } else {
                formActionUrl = formApiUrl('admin/employee/engineer/add');
                // Load autocompletes
                loadAutocompleteRegions();
                loadAutocompleteDepartments();
                loadAutocompleteDesignations();
                await loadAutocompleteAddressCountries({
                    element: $('#employeeEngineerForm [name="country_id"]'),
                    params: {
                        selected: [101]
                    }
                });
                await loadAutocompleteAddressStates({
                    element: $('#employeeEngineerForm [name="state_id"]'),
                    params: {
                        country_id: 101
                    }
                });
