    ...
    <div class="card card-body p-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a data-toggle="modal" href="#camUploadModal" data-backdrop="static" data-keyboard="false" class="btn btn-outline-info mt-1"><i class=" mdi mdi-folder-upload"></i> Upload</a>
                    <a href="<?php echo base_url('admin/cam/add') ?>" class="btn btn-outline-primary mt-1"><i class="mdi mdi-account-plus"></i> Add</a>
        ...
        <br>
        <div class="row" data-container="empCAMArea"></div>

        <div class="row align-items-center justify-content-between" data-pagination="empCAMArea">
            <div class="col">
...
<!-- Upload Modal -->
<div class="modal fade" id="camUploadModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button form="uploadForm" class="btn btn-primary" id="btn-upload-cam">Submit</button>
            </div>
        </div>
    </div>
</div>

<div id="camListModal" class="modal fade add-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title">Client Account Manager List</h4>
            </div>
            ...
            <form id="uploadForm" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/formdata">   
                <div class="modal-body" style="overflow: scroll;max-height: 400px;">                                                                 
                   <div class="table-responsive-sm mt-6">
                        <table id="camTableId" class="table table-striped table-centered mb-0">
                        </table>
                    </div>    
                </div> 
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-cancel" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary" id="cam-submit">Submit</button>   
                </div>                                                   
            </form>
        </div>
    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/admin/cam_list.js'); ?>"></script>
<script src="<?php echo base_url('assets/plugins/bootstrap-filestyle/js/bootstrap-filestyle.min.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/admin/upload_cam.js'); ?>"></script>
<script>
    $(function() {
        $('[data-toggle="select2"]').select2();

        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('admin/employee/client_account_manager/list'));
        }
