...
<body class="fixed-left" style="height: 100vh;">
                ...
                <div class="card mx-auto col-10 col-md-8">
                    <div class="card-body">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <form class="form-horizontal m-t-30" id="customerLoginForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url() ?>customer/password/forgot/" class="text-muted float-right" style="font-size:14px;"><i class="mdi mdi-lock"></i> Forgot password?</a>
    ...
    <script src="<?= base_url('assets/js/include/customer/login.js') ?>"></script>
    <script>
        $(function() {
