...
<script src="<?php echo base_url('assets/js/include/employee/customer/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/customer/contract_job/list'));
        }
