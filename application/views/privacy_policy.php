...
<html lang="en">
    <head>
        ...
        <title>Privacy Policy | Sterling Wilson</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <!-- Image Logo -->
                <a class="navbar-brand logo-image"><img src="<?php echo base_url('assets/images/sterling-wilson.png'); ?>" alt="alternative"></a> 
        ...
        <div class="breadcrumbs">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumbs">
                            <a href="index.html">Home</a><i class="fa fa-angle-double-right mx-2"></i><span>Privacy Policy</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="text-container">
                            <h5>License Types & Template Usage</h5>
                        ...
                        <div class="text-container">
                            <h5>Designer Membership And How It Applies</h5>
                        ...
                        <div class="text-container last">
                            <h5>Assets Used In The Live Preview Content</h5>
