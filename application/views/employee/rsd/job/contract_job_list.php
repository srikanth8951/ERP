...
<script src="<?php echo base_url('assets/js/include/employee/rsd/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/rsd/contract_job/list'));
        }
