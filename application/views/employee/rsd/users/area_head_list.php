...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/rsd/area_head_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('employee/rsd/users/area_head/list'));
        }
