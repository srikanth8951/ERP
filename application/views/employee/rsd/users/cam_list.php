...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/rsd/cam_list.js'); ?>"></script>
<script>
    $(function() {
        $('[data-toggle="select2"]').select2();

        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('employee/rsd/users/client_account_manager/list'));
        }
