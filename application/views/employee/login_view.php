...
<body class="fixed-left" style="height: 100vh;">
    ...
    <div class="row align-items-center justify-content-center h-100 my-auto">
        <div class="col-md-6">
                ...
                <div class="card mx-auto col-10 col-md-8">
                    <div class="card-body">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <form class="form-horizontal m-t-30" id="empLoginForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url() ?>employee/password/forgot/" class="text-muted float-right" style="font-size:14px;"><i class="mdi mdi-lock"></i> Forgot password?</a>
            ...
            <div class="m-t-40 clearfix px-4 text-center">
    ...
    <script src="<?= base_url('assets/js/include/employee/login.js') ?>"></script>
    <script>
        $(function() {
