...
<html lang="en">
    ...
    <body class="fixed-left" style="height: 100vh;">
        ...
        <script src="<?php echo base_url('assets/js/include/employee/password_reset.js')?>"></script>
        <script src="<?php echo base_url('assets/js/include/employee/password_reset_otp.js')?>"></script>
        <script src="<?php echo base_url('assets/js/include/employee/forgot_password.js')?>"></script>
