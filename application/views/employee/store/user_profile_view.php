        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url(); ?>employee/store/dashboard" class="btn btn-outline-secondary mt-1"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <form id="userProfileForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>employee/store/dashboard" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/store/profile_form.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            formActionUrl = formApiUrl('employee/store/profile/edit');
            loadUserDetail();
        }
