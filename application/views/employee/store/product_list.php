                            ...
                            <div class="col-12">
                                <h4 class="mt-0 header-title">
                                    <div class="text-right">
                                        <a href="<?= base_url() ?>employee/store/products/add" class="btn btn-outline-primary waves-effect waves-light">Add</a>
                                    </div>
                                </h4>
                            </div>
                        </div>
...
<script src="<?php echo base_url('assets/js/include/employee/store/product_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('employee/store/product/list'));
        }
