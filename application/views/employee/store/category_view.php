<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        <div class="card m-b-20" id="store_category--deatils--area">
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12 text-right">
                        ...
                        <button id="btn-add-store_category" class="btn btn-outline-primary waves-effect waves-light">Add</button>
                    </div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-12" data-container="store_categoryListArea">
                        <div class="table-responsive mb-4">
                            <table class="table table-bordered dt-responsive nowrap">
                                ...
                                <tbody data-container="store_categoryTlistArea">
                                </tbody>
                            </table>
                        </div>
                        <div data-pagination="store_categoryTlistArea" class="clearfix mb-4">
...
<!-- store_category Modal -->
<div class="modal fade" id="store_categoryModal">
    <div class="modal-dialog modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="font-18 modal-title">Category</h4>
                <button type="button" data-dismiss="modal" class="close"><i class="mdi mdi-close"></i></button>
            </div>
            <div class="modal-body">
                <form id="store_categoryForm" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="form-group">
                        <a href="javascript:void(0)" id="btn-reset-store_category-form" class="btn btn-secondary btn-sm" style="display:none;">
...
<script src="<?php echo base_url('assets/js/include/employee/store/category.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('employee/store/category/list'));
        }
