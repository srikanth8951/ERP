...
<script src="<?php echo base_url('assets/js/include/employee/asd/store_request_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('employee/asd/store_product/request/list'));
        }
