...
<script src="<?php echo base_url('assets/js/include/employee/asd/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/asd/contract_job/list'));
        }
