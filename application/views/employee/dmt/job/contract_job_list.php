        ...
        <div class="p-2" style="background-color: #dee1e5;"> 
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url('employee/dmt/contract_job/add') ?>" class="btn  btn-outline-primary waves-effect waves-light ">Add</a>
                </div>
            </div>
        </div>
        <br>
...
<script src="<?php echo base_url('assets/js/include/employee/dmt/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/dmt/contract_job/list'));
        }
