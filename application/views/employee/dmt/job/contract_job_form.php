        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    ...
                    <a href="<?php echo base_url('employee/dmt/contract_job'); ?>" class="btn btn-outline-secondary waves-effect waves-light"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
        <div class="job_cls">
            <form class="" action="#" id="contract-job-form">
                    ...
                    <div class="col-lg-12">
                        <div class="card m-b-20">
                            <div class="card-body customer-detail-area">
                                ...
                                <div class="row">
                                    <div class="col-md-12 pb-3" id="same-address-area">
                            ...
                            <div class="card-body contractjob-detail-area">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>CAM</label>
                                            <select name="customer_account_manager" class="form-control select2" data-toggle="select2">
                                                <option value="" disabled>Select</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="engineer" class="form-control select2" data-toggle="select2" id="select_engineer">
                                                <option value="" disabled>Select</option>
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="form-group">
                    <div>
                        ...
                        <a href="<?php echo base_url(); ?>employee/dmt/contract_job" class="btn btn-secondary waves-effect">
                            Cancel
                        </a>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        ...
        window.contractJobForm = $('#contract-job-form');
...
<script src="<?php echo base_url('assets/js/include/employee/dmt/contract_job_form.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/employee/dmt/contract_job_asset.js'); ?>"></script>
<script src="<?php echo base_url('assets/js/include/employee/dmt/contract_job_asset_upload.js'); ?>"></script>
    ...
    $(function() {
        ...
        async function loadInitFunctions() {
            if (emp_form_type == 'update') {
                formActionUrl = formApiUrl('employee/dmt/contract_job/update', {
                    contract_job_id: contract_job_id
                });
                loadContractJobDetail();
            } else if (emp_form_type == 'renew') {
                formActionUrl = formApiUrl('employee/dmt/contract_job/renew', {
                    contract_job_id: contract_job_id
                });
                loadContractJobDetail();
            } else {
                formActionUrl = formApiUrl('employee/dmt/contract_job/add');
            ...
            // }).then(function(placeSearch) {
            //     console.log(placeSearch.getPlace());
            //     // placeSearch.addListener("place_changed", function () {
            //     //     let place = placeSearch.getPlace();
