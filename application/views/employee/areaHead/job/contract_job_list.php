...
<script src="<?php echo base_url('assets/js/include/employee/areaHead/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/areaHead/contract_job/list'));
        }
