...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/aisd/customer_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadCustomerDetails(formApiUrl('employee/aisd/customer/list'));
        }
