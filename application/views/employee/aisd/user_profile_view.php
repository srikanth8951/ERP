                ...
                <form id="userProfileForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>employee/aisd/dashboard" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/aisd/profile_form.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            formActionUrl = formApiUrl('employee/aisd/profile/edit');
            loadUserDetail();
        }
