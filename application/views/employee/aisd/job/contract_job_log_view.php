        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url('employee/aisd/contract_job_log/' . $back_contract_job_id); ?>" class="btn btn-outline-secondary waves-effect waves-light"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
