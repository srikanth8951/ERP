...
<script src="<?php echo base_url('assets/js/include/employee/aisd/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/aisd/contract_job/list'));
        }
