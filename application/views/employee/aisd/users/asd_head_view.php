        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    <a href="<?php echo base_url(); ?>employee/aisd/users/asd_head" class="btn btn-outline-secondary mt-1"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/aisd/asd_head_view.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetail(formApiUrl('employee/aisd/users/asd_head/detail', {
