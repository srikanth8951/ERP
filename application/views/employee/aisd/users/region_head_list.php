...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/aisd/region_head_list.js'); ?>"></script>
<script>
    $(function() {
        $('[data-toggle="select2"]').select2();

        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('employee/aisd/users/region_head/list'));
        }
