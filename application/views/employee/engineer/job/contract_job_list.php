...
<script src="<?php echo base_url('assets/js/include/employee/engineer/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/engineer/contract_job/list'));
        }
