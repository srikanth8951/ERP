        ...
        <div class="card card-body p-2 mb-2">
            <div class="row">
                ...
                <div class="col text-right">
                    ...
                    <a href="<?php echo base_url('employee/regionHead/contract_job_log/' . $contract_job_id); ?>" id="btn-log" class="btn btn-outline-indigo m-r-5 waves-effect waves-light">Logs</a>
                    <a href="<?php echo base_url('employee/regionHead/contract_job'); ?>" class="btn btn-outline-secondary waves-effect waves-light"><i class="mdi mdi-chevron-double-left"></i> Back</a>
                </div>
            </div>
        </div>
