...
<script src="<?php echo base_url('assets/js/include/employee/regionHead/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/regionalHead/contract_job/list'));
        }
