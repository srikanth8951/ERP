                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="float-right" id="add-button-area">
                                    <a href="<?php echo base_url('employee/regionHead/checklist'); ?>" class="btn btn-secondary btn-sm waves-effect waves-light ml-2"><i class="mdi mdi-arrow-left-bold mr-2"></i>Back</a>
    ...
    <?php $this->document->addScript(base_url('assets/js/include/employee/regionHead/checklist_view_type1.js')); ?>
    <?php $this->document->addScript(base_url('assets/js/include/employee/regionHead/checklist_view_type2.js')); ?>
