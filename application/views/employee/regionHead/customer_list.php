...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/regionHead/customer_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadCustomerDetails(formApiUrl('employee/regionalHead/customer/list'));
        }
