...
<script src="<?php echo base_url('assets/js/include/employee/regionHead/store_request_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadDetails(formApiUrl('employee/regionalHead/store_product/request/list'));
        }
