                ...
                <form id="userProfileForm" action="#">
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <a href="<?php echo base_url(); ?>employee/regionHead/dashboard" class="btn btn-secondary waves-effect">
                                Cancel
                            </a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/regionHead/profile_form.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            formActionUrl = formApiUrl('employee/regionalHead/profile/edit');
            loadUserDetail();
        }
