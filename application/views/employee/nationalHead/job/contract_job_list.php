...
<script src="<?php echo base_url('assets/js/include/employee/nationalHead/contract_job_list.js'); ?>"></script>
...
<script>
    $(function(){
        ...
        function loadInitFunctions() {
            loadContractJobDetails(formApiUrl('employee/nationalHead/contract_job/list'));
        }
