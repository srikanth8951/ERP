...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/nationalHead/area_head_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadEmpDetails(formApiUrl('employee/nationalHead/users/area_head/list'));
        }
