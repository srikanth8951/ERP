...
<script type="text/javascript" src="<?php echo base_url('assets/js/include/employee/nationalHead/customer_list.js'); ?>"></script>
...
<script>
    $(function() {
        ...
        function loadInitFunctions() {
            loadCustomerDetails(formApiUrl('employee/nationalHead/customer/list'));
        }
