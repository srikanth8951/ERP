            ...
            <div class="col">
                <div class="card m-b-20">
                    <div class="card-header d-flex align-items-center justify-content-between bg-white">
                        ...
                        <a href="<?php echo base_url('employee/nationalHead/asset'); ?>" class="btn btn-sm btn-outline-secondary waves-effect waves-light"><i class=" mdi mdi-chevron-double-left"></i>&nbsp;Back</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url('assets/js/include/employee/nationalHead/asset_view.js'); ?>"></script>
